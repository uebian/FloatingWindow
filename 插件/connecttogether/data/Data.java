...
public class Data
{
	...
	public static synchronized void loadUser() throws Exception
	{
		File f=new File(DIR);
	...
	public static synchronized void loadGroup() throws Exception
	{
		File f=new File(DIR);
		if(!f.exists())f.mkdirs();
	...
	public static synchronized void saveGroup()
	{
		File f=new File(DIR);
		if(!f.exists())f.mkdirs();
		SAXTransformerFactory sf=(SAXTransformerFactory)SAXTransformerFactory.newInstance();
